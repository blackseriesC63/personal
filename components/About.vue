<template>
  ...
  <div class="mx-auto px-4 py-8 grid lg:grid-cols-3 gap-8">
    <!-- Statistics Section -->
    <div class="space-y-6">
      <div class="bg-gray-100 p-6 rounded-lg shadow-md text-start">
        <p class="text-4xl font-bold text-gray-800 pb-8">170+</p>
        <p class="text-gray-500">Товаров</p>
      </div>
      <div class="bg-gray-100 p-6 rounded-lg shadow-md text-start">
        <p class="text-4xl font-bold text-gray-800 pb-8">1000+</p>
        <p class="text-gray-500">Довольных покупателей</p>
      </div>
      <div class="bg-gray-100 p-6 rounded-lg shadow-md text-start pb-8">
    ...
    <div class="lg:col-span-2 space-y-6 text-gray-700 leading-relaxed">
      <p>
        Интернет-магазин NORN LIGHT предлагает широкий ассортимент светильников
  ...
  <h1 class="container mx-auto px-6 text-6xl">О компании</h1>
